...
r.get('/', auth, (req, res) => {
  ...
  res.json({
    ...
    wechat_pay: {
      ...
      platform_pubkey_set: !!data.wechat_pay_platform_pubkey
    },
    tencent_verify: {
...
const ALLOWED = new Set([
  ...
  'wechat_pay_mchid', 'wechat_pay_apiv3_key', 'wechat_pay_serial_no', 'wechat_pay_private_key', 'wechat_pay_notify_url', 'wechat_pay_platform_pubkey',
