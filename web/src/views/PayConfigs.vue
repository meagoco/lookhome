...
const blank = { id: null, name: '', mchid: '', apiv3_key: '', serial_no: '', private_key: '', notify_url: '', appid: '', property_ids: [], apiv3_key_set: false, private_key_set: false };
...
async function openEdit(row) {
  ...
  Object.assign(form, {
    ...
    property_ids: d.property_ids || [], apiv3_key_set: d.apiv3_key_set, private_key_set: d.private_key_set
  });
  dlg.value = true;
}
